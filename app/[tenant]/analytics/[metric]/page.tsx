...
export default function AnalyticsDetailPage() {
  ...
  const { data: analyticsData } = useAnalytics(tenant?.id || '');
    ...
    switch (metric) {
      case 'revenue':
        return {
          ...
          data: {
            current: analyticsData.revenue.value,
      ...
      case 'users':
        return {
          ...
          data: {
            current: analyticsData.dailyActiveUsers.value,
      ...
      case 'engagement':
        return {
          ...
          data: {
            current: analyticsData.engagement.value,
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="print-only mb-8">
          ...
          <p className="text-gray-600">Generated by: {user?.name}</p>
        </div>
